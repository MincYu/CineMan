...
/**
 * other packet from Internet
 * use KMeans to classify the customers
 *
 * Created on 16/7/26.
 */
public class KMeans {
    ...
    public static void main(String[] args) {
        ...
        dataSet.add(new float[]{0.2f,0.3f,0.5f});
        dataSet.add(new float[]{0.3f,0.3f,0.4f});
        dataSet.add(new float[]{0.15f,0.4f,0.45f});
        dataSet.add(new float[]{0.5f,0.4f,0.1f});
        dataSet.add(new float[]{0.8f,0.1f,0,1f});
        dataSet.add(new float[]{0.4f,0.5f,0,1f});
        dataSet.add(new float[]{0.6f,0.4f,0});
        dataSet.add(new float[]{0.3f,0.1f,0.6f});
        dataSet.add(new float[]{0.2f,0.8f,0});
        dataSet.add(new float[]{0.4f,0.2f,0.4f});
        dataSet.add(new float[]{0.1f,0.9f,0});
        dataSet.add(new float[]{0.7f,0,0.3f});
